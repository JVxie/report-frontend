...
layui.define(['table', 'form'], function(exports){
    ...
    //教师列表
    table.render({
        elem: '#LAY-student-teacher-list'
        ,url: setter.userRole.student.api + '/teacher'
        ,headers: {
        ...
        ,cols: [[
            ...
            ,{title: '操作', fixed: 'right', toolbar: '#table-student-teacher-list', unresize: true, minWidth: 120, align: 'center'}
        ]]
    ...
    //监听教师列表工具条
    table.on('tool(LAY-student-teacher-list)', function(obj){
        var data = obj.data;
        if(obj.event === 'check'){
            admin.popup({
                title: '查看教师信息'
                ,area: ['400px', '450px']
                ,id: 'LAY-popup-student-edit'
                ,success: function(layero, index){
                    view(this.id).render('student/teacher/form', data).done(function(){
