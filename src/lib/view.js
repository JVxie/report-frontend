...
layui.define(['laytpl', 'layer'], function(exports){
  ...
  view.req = function(options){
    ...
    if(request.tokenName){
      ...
      options.headers[request.headerTokenName] = request.headerTokenName in options.headers
        ?  options.headers[request.headerTokenName]
      : (request.tokenPrefix + layui.data(setter.tableName)[request.tokenName] || '');
    }
